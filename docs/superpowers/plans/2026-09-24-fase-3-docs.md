...
- Modify: `specs/01-dominio-e-regras-de-negocio.md` (glossário: `EstruturaItem.QuantidadePorPai`,
  "Aguardando coleta", "Montado" e três entradas novas; regras 9, 14, 22, 24 e 26; a nota antes da regra
...
- [ ] **Step 7: Regra 14 — o início real de produção sai do livro**

Achado no preflight da execução, ausente da seção 10 da spec: a regra 14 define o início real pelo
`EstruturaSetorHistorico` e pelo `DataInicioExecucao`, que o Plano 2 remove. Com a regra 28, a primeira
entrada **é** o início do trabalho.
...
- [ ] **Step 8: A nota antes da regra 22**
...
- [ ] **Step 9: Regra 22 — a representação no banco**
...
- [ ] **Step 10: Regra 24 — montar vale para todo nó com filhos**
...
- [ ] **Step 11: Regra 26 — para que serve a razão**
...
- [ ] **Step 12: Regras novas 28 a 30, depois da regra 27**
...
- [ ] **Step 13: Pontos ainda em aberto — o item decidido sai, e o "Descontinuar" ganha nota**
...
A contagem é **seis**, não cinco: a base já dizia "quatro" sobre cinco itens (a causa da regra 18
entrou na 2B sem atualizar o número). Corrigido na review da Task 2.
