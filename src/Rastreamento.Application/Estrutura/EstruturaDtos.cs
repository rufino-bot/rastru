...
/// junto de `ComponenteId` era descartado em silencio. `QuantidadePorPai` obrigatoria no Item e
/// proibida na Peca (regra 26).
/// </summary>
...
/// `QuantidadePorPai` obrigatoria no Item e proibida na Peca (regra 26).
/// </summary>
